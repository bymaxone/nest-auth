...
describe('ResendOtpDto', () => {
  // Verifies that a fully valid ResendOtpDto passes class-validator with zero errors.
  ...
  it('should normalize email to lowercase and trimmed via @Transform', () => {
    const dto = plainToInstance(ResendOtpDto, {
  ...
  it('should pass non-string email through @Transform unchanged', () => {
    const dto = plainToInstance(ResendOtpDto, { email: 42, tenantId: 'tenant-1' })
