...
describe('ForgotPasswordDto', () => {
  // Verifies that a fully valid ForgotPasswordDto passes class-validator with zero errors.
  ...
  it('should pass non-string email through @Transform unchanged', () => {
    const dto = plainToInstance(ForgotPasswordDto, { email: 42, tenantId: 'tenant-1' })
